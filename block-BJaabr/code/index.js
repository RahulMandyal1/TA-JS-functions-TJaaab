...
// - Write an Arrow Function without curly brackets(if possible)
// Not possible writing a statement on Right hand side 
// - Write an Arrow Function with curly brackets
const isGreater = (x,y) => { 
  if(x > y){
    return true;
...
isGreater(4,6);
// - Execute the function and store the return value in a variable
 let greaterOrNot = isGreater(5,6)
// - What is the typeof returnValue
typeof greaterOrNot // Boolean
/* 6.
...
// Not possible writing a statement on Right hand side  because if  is a statement 
// - Write an Arrow Function with curly brackets
...
oddOrEven(4);
// - Execute the function and store the return value in a variable
let oddEven = oddOrEven(3);
// - What is the typeof returnValue
typeof oddEven ; // string becuase  return statement contains '${number} is even'